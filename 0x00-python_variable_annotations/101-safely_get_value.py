...
def safely_get_value(dct: Mapping, key: Any, default: Union[T, None] = None) -> Union[Any, T]:
    ...
    Otherwise, the default value (or None if no default is provided) is returned.

    Returns:
        Union[Any, T]: The value from the dictionary, or the default value if the key is not found.
    """
    if key in dct:
        return dct[key]
    else:
